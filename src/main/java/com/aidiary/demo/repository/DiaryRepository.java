...
public interface DiaryRepository extends JpaRepository<Diary, Integer> {
    ...
    @Query("select new com.aidiary.demo.dto.DiaryResponseDto(m.diaryId, m.userId, m.title, m.contents, m.rating1, m.rating2, m.rating3, m.date) from Diary m where m.userId = :userId")
