...
public interface DiaryRepository extends JpaRepository<Diary, String> {
    ...
    @Query("select new com.aidiary.demo.dto.DiaryResponseDto(m.userId, m.title, m.contents, m.rating1, m.rating2, m.rating3, m.date) from Diary m where m.userId = :userId")
